...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Comment_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Comment_t qt_meta_stringdata_Comment = {
    {
QT_MOC_LITERAL(0, 7), // "Comment"
QT_MOC_LITERAL(8, 8), // "setPoint"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 15) // "on_save_clicked"

    },
    "Comment\0setPoint\0\0on_save_clicked"
};
...
void Comment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Comment *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->setPoint((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject Comment::staticMetaObject = { {
    ...
    qt_meta_stringdata_Comment.offsetsAndSize,
    qt_meta_data_Comment,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Comment_t

...
void ForgetPWD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ForgetPWD *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject ForgetPWD::staticMetaObject = { {
    ...
    qt_meta_stringdata_ForgetPWD.offsetsAndSize,
    qt_meta_data_ForgetPWD,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ForgetPWD_t

, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QKeyEvent *, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
void *ForgetPWD::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ForgetPWD.stringdata0))
